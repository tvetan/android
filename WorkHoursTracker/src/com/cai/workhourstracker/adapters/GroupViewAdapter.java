...
public abstract class GroupViewAdapter extends BaseAdapter implements
		SectionIndexer, OnScrollListener {
	public static final String TAG = GroupViewAdapter.class.getSimpleName();
	...
	public void setHasMorePagesListener(
			HasMorePagesListener hasMorePagesListener) {
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		if (view instanceof GroupListView) {
			((GroupListView) view).configureHeaderView(firstVisibleItem);
		}
	}
